...
import com.facilitydoor.app.facilitydoor.RegistrationActivity;
...
public class ConnectionRegister {
    ...
    public ConnectionRegister(HashMap<String,String> params,String url,Context context,RegistrationActivity registrationActivity) {
        this.params=params;
        this.url=url;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Log.v("Not working",error.toString());
                    }
                }) {
            @Override
    ...
    private void parsejsonconnect(String response) {
        registrationActivity.parsejson(response);
